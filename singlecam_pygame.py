#=============================================================================================================
# singlecam_pygame-FILE-for-RGB-Detection-from-simulation-by-Michael_Micah,ENGR.DR.MARTINS_OBASEKI (2024)-----
#=============================================================================================================


""" 
    This code integrates YOLO object detection with the CARLA simulator, 
    where it captures real-time RGB images from a vehicle, 
    processes them to detect objects, 
    and displays the results with bounding boxes using Pygame.
"""

# Importing necessary libraries, including YOLO for object detection, Pygame for display, Carla for simulation,
# and other utilities for processing and argument parsing.
...
IM_WIDTH = 640  # can be changed to desire dimensions
IM_HEIGHT = 480 # can be changed to desire dimensions
...
# Loading a pre-trained YOLOv8 model for object detection in the simulated environment.
model = YOLO(r"C:\CARLA_0.9.5\PythonAPI\examples\models\yolov8_run\content\runs\detect\train\weights\best.pt") # can be changed to desire path to your model
...
custom_classes = {
    ...
    5: 'car',          # Car
    6: 'motorbike',
    7: 'green_light',  # Green traffic light
    8: 'pedestrian',   # Pedestrian
    9: 'red_light',    # Red traffic light
    10: 'truck',        # Truck
}
...
def draw_bounding_boxes(image, detections):
    ...
    for detection in detections:
        ...
        if conf >= CONFIDENCE_THRESHOLD:
            ...
            label = f"{class_name}: {conf:.2f}" # the f-string is used to create a label that includes the class name and confidence score, formatted to two decimal places (:.2f).
...
# Function to process the raw RGB image obtained from the Carla simulator.
...
def main():
    ...
    global  screen  # Define global variables to be used in the Pygame display.
    ...
    #===============================
        ...
        cleanup(actor_list)  # Cleaning up all actors and resources when exiting.
